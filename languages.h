#define LANG_DE
  ...
  #define MSG_WIFI_TITLE    "WiFi"
  #define MSG_SEARCH_WIFI   "Suche WLAN"
  #define MSG_FOUND_WIFI    "OK!"
  #define MSG_NO_WIFI       "FEHLER!"  
  #define MSG_NO_WIFI       "Nicht verbunden!"
...
//#define LANG_EN
  ...
  #define MSG_WIFI_TITLE    "WiFi"
  #define MSG_SEARCH_WIFI   "Searching WLAN"
  #define MSG_FOUND_WIFI    "OK!"
  #define MSG_NO_WIFI       "FAILED!"
  #define MSG_NO_WIFI       "Not connected!"
